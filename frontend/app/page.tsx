      ...
      <section className="lg:pl-64">
        <header className="sticky top-0 z-10 border-b border-[#dfe5ef] bg-white/95 px-5 py-4 backdrop-blur lg:px-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-xl font-semibold tracking-normal">AI 股票研究工作台</h1>
              <p className="mt-1 text-sm text-[#697386]">即时分析在前，仪表盘预览在后，保持个人研究辅助边界。</p>
            </div>
        ...
        <div className="px-5 py-6 lg:px-8">
          <section id="instant-analysis" className="scroll-mt-24">
            ...
            <div className="mt-5 rounded-md border border-[#111827] bg-[#151d2a] p-4 text-white">
            ...
            {task && !result ? (
              <section className="mt-5 rounded-md border border-[#dfe5ef] bg-white">
            ...
            {result ? (
              <>
                ...
                <div className="mt-5 rounded-md border border-[#b7dfd4] bg-[#eef8f5] px-4 py-3 text-sm text-[#146a55]">{result.disclaimer}</div>
              </>
            ) : (
              <section className="mt-5 rounded-md border border-[#dfe5ef] bg-white p-8 text-center">
                <AlertTriangle className="mx-auto text-[#697386]" size={28} />
                <div className="mt-3 text-sm font-semibold">尚未生成分析结果</div>
                <p className="mt-2 text-sm text-[#697386]">验收路径：输入 002436，选择 中期，点击 开始分析。</p>
              </section>
            )}
          </section>

          <section id="dashboard" className="mt-8 scroll-mt-24">
            <div className="mb-5">
              <h2 className="text-xl font-semibold tracking-normal">投研仪表盘预览</h2>
